...
* Компоненты используют *сервисы*, которые предоставляют определенные функциональные возможности, не связанные напрямую с представлениями. Поставщики сервисов могут быть *внедрены* в компоненты как *зависимости*, что делает ваш код модульным, повторно используемым и эффективным.
