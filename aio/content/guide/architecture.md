...
Компоненты приложения обычно определяют множество видов, расположенных в иерархически. Angular обеспечивает `Router` сервис чтобы помочь вам определить пути навигации между представлениями. Маршрутизатор обеспечивает сложные навигационные возможности в браузере.
