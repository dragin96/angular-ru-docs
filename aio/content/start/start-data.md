...
1. Определите методы для добавления элементов в корзину, получения элементов корзины и очистки элементов корзины:
    ...
    * `getItems()` собирает элементы, добавленные пользователями в корзину, и возвращает каждый элемент с соответствующим количеством.
