...
/**
 *
 * Макет соединения для представления {@link Connection} для испытаний.
 *
 *  @usageNotes
 *  ### Пример `mockRespond()`
 *
...
/**
 * Макет бэкэнда для тестирования {@link Http} служба.
 *
 * Этот класс может быть введен в тестах и должен использоваться для переопределения поставщиков
 * для других бэкэндов, таких как{@link XHRBackend},
 *
 *  @usageNotes
 *  ### Пример
 *
