 ...
 * Если все охранники вернут `true` , навигация продолжится. Если какойлибо охранник возвращает `false`,
 * навигация будет отменена. Если какой-либо охранник возвращает `UrlTree` , текущая навигация будет
 * отменена, и новая навигация будет `UrlTree` возвращенного из охранник.
 *
 *  ```
 *  class UserToken {}
 *  class Permissions {
